...
const Followup = () => {
  ...
  const fetchReminders = async () => {
    try {
      ...
      const res = await axios.get(
        "https://citamedfront.vercel.app/api/reminders",
        {
  ...
  const handleToggleCompleted = async (id, currentState) => {
    try {
      ...
      const res = await axios.put(
        `https://citamedfront.vercel.app/api/reminders/${id}/completed`,
  ...
  const handleToggleFavorite = async (id) => {
    try {
      const token = localStorage.getItem("token");
      const res = await axios.put(
        `https://citamedfront.vercel.app/api/reminders/${id}/favorite`,
        {},
        { headers: { Authorization: `Bearer ${token}` } }
      );
